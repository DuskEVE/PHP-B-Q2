...
<div class="container" style="padding:10px 5% 10px 5%">

    <div class="nav-bar" style="display: flex; margin-bottom: -1px;">
        <div class="nav-btn on" data-target="item-1">健康新知</div>
        <div class="nav-btn" data-target="item-2">菸害防治</div>
        <div class="nav-btn" data-target="item-3">癌症防治</div>
        <div class="nav-btn" data-target="item-4" style="border-right: 1px solid black;">慢性病防治</div>
    </div>
